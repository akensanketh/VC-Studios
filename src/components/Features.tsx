  ...
  const cardData = [
    {
      ...
      desc: "Advanced colorimetry tuning, carefully calibrated for rich emotional resonance and pristine theatrical color grading styles."
    },
    {
      title: "Invisible VFX",
      icon: <VFXCompositingIcon />,
      desc: "Photorealistic digital environment design and seamless green screen compositing with uncapped real-time rendering pipelines."
    },
    {
      title: "Spatial Soundscapes",
      icon: <SoundDesignIcon />,
      desc: "Dynamic multi-channel sound editing and foley setups, fully mixed in surround sound layouts and cinematic Dolby formats."
    }
  ];

  return (
    <section id="features" className="w-full bg-transparent text-white pb-32 pt-2 px-6 sm:px-10 lg:px-16 xl:px-24 animate-fade-in">
          ...
          {cardData.map((item, idx) => (
            ...
            >
              <div>
                ...
                {/* Subtext description mapped into beautiful continuous paragraph layout */}
                <p className="text-[14px] sm:text-[15px] leading-relaxed text-zinc-400 font-light font-sans antialiased text-left select-text">
                  {item.desc}
                </p>
              </div>
