...
export default function HeroSection({ onGetInTouchClick }: HeroSectionProps) {
  return (
    <section id="hero" className="relative w-full overflow-hidden bg-transparent text-white py-16 sm:py-24 lg:py-32">
      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-24 relative">
        <div className="max-w-4xl">
          ...
          {/* Main heading */}
          <h1 className="text-[34px] sm:text-[46px] md:text-[54px] lg:text-[60px] leading-[1.25] font-light tracking-normal text-white mb-10">
            <motion.span
              initial={{ opacity: 0, y: 15 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, ease: "easeOut" }}
              className="block mb-3 font-light"
            >
            ...
            <motion.span
              ...
              className="block font-light text-zinc-200"
            >
